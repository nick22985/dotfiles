-- Catppuccin Mocha palette. Converted from theme/mocha.conf.
--
-- NOTE: these colors were NOT referenced anywhere in the original hypr config
-- (the .conf was sourced but never used). Kept as a returned module so they're
-- available for future use, e.g.  local mocha = require("theme.mocha")
-- then  mocha.blue  /  mocha.baseAlpha.
